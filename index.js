...
async function checkNewApartments() {
  ...
  try {
    ...
    if (newApartments.length > 0) {
      ...
      // Adiciona checkIndex e checkTimestamp em cada apartamento novo
...
⏰ Próxima verificação: ${nextCheck}`;
      ...
      // Atualiza o checkIndex mesmo sem novos apartamentos
      data.lastCheckIndex = checkIndex;
      saveApartmentsData(data);
...
// Rodar a cada X horas (definido em CRON_INTERVAL_HOURS)
